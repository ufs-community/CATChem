help([[
  This module loads libraries required for building and running Configurable ATmospheric Chemistry Component
  on the NOAA RDHPC machine Gaea C5 using Intel-2023.1.0.
]])

whatis([===[Loads libraries needed for building the Configurable ATmospheric Chemistry Component on Gaea C5 ]===])
