...
CATChem is developed as an open-source community project. The software is provided under the following license terms:
...
CATChem incorporates several third-party libraries and components:

### GOCART Aerosol Module
- **License**: NASA Open Source Agreement
- **Source**: NASA GSFC GOCART model
- **Purpose**: Aerosol transport and chemistry

### NetCDF Libraries
- **License**: NetCDF License (BSD-style)
- **Source**: Unidata NetCDF
- **Purpose**: Data I/O and file format support
...
CATChem development has been supported by:
...
By contributing to CATChem, you agree to license your contributions under the same Apache License that covers the project. See our **[Contributing Guide](developer-guide/contributing.md)** for details.

## Contact

For licensing questions or permissions beyond the scope of this license, please contact the CATChem development team through our **[GitHub repository](https://github.com/UFS-Community/CATChem/issues)**.
