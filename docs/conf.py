...
latex_documents = [
    (master_doc, 'CATChem.tex', u'CATChem Documentation', u'authors', 'manual'),
]
...
man_pages = [(master_doc, 'CATChem', u'CATChem Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'CATChem', u'CATChem Documentation', author, 'CATChem', 'Congfigurable atmospheric chemistry component.', 'Miscellaneous'),
]
