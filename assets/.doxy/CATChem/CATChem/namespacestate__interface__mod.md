...
# Namespace state\_interface\_mod



[**Namespace List**](namespaces.md) **>** [**state\_interface\_mod**](namespacestate__interface__mod.md)
...
|  subroutine | [**validator\_validate\_dimensions**](#function-validator_validate_dimensions) (class([**statevalidatorutilstype**](namespacestate__interface__mod.md#none-statevalidatorutilstype)), intent(in) this, integer, dimension(:), intent(in) array\_shape, integer, dimension(:), intent(in) expected\_shape, integer, intent(out) rc) <br>_Validate array dimensions._  |
...
### function validator\_validate\_dimensions 

_Validate array dimensions._ 
```Fortran
