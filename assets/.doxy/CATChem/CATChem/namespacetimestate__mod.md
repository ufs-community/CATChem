...
| Type | Name |
| ---: | :--- |
|  real function | [**get\_sza**](#function-get_sza) (class([**timestatetype**](namespacetimestate__mod.md#none-timestatetype)), intent(in) this, real, intent(in) lat, real, intent(in) lon) <br>_Compute solar zenith angle (degrees) using latitude, longitude, and time of day._  |
...
```Fortran
real function timestate_mod::get_sza (
