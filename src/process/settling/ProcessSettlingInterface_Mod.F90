...
!! Generation date: 2025-12-17T15:27:52.051360
...
contains
   ...
   subroutine run_gocart_scheme_column(this, column, rc)
      ...
      allocate(zmid(n_levels))  ! Atmospheric field - always n_levels
      ...
      zmid(1:n_levels) = met%ZMID(1:n_levels)  ! Atmospheric field - always n_levels
