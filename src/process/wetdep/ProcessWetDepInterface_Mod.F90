...
!! Generation date: 2025-11-25T22:19:36.178758
...
contains
   ...
   subroutine run_jacob_scheme_column(this, column, rc)
      ...
      allocate(pfilsan(n_levels))  ! Atmospheric field - always n_levels
      allocate(pfllsan(n_levels))  ! Atmospheric field - always n_levels
      ...
      pfilsan(1:n_levels) = met%PFILSAN(1:n_levels)  ! Atmospheric field - always n_levels
      pfllsan(1:n_levels) = met%PFLLSAN(1:n_levels)  ! Atmospheric field - always n_levels
